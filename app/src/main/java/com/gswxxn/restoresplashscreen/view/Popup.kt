...
class Popup(private val context: Context, view: View, private val currentValue: String, private val dataBacks: (String) -> Unit, private val arrayList: ArrayList<MIUIPopupData>): ListPopupWindow(context) {
                ...
                return (p1 as? LinearLayout ?: LinearLayout(context)).apply {
                    ...
                    addView((object : TextView(context) {
                       init {
                        ...
                        layoutParams = LinearLayout.LayoutParams(dp2px(context, 145f), LinearLayout.LayoutParams.WRAP_CONTENT)
